...
import { fetchCities, fetchRecommendations, fetchRefinedRecommendations, postSurvey, fetchRecommendationWithCritiques, fetchInitialRecommendationWithCritiques } from './api';
...
class Recommender extends Component {
  ...
  incrementClickCount = () => {
    ...
    if (pathname === '/rec/preferences' || pathname === '/rec/refining' || pathname === '/rec/critiquing') {
      ...
      return [
        {
          name: '1. Tell us your general preferences',
          pathname: 'preferences',
          onNextClick: () => { this.getInitialRecommendationWithCritiques(); this.goToNextStep(`${match.path}/critiquing${location.search}`) },
          nextButtonText: 'next step',
          disabledMessage: `Please select from ${CITY_SELECTION_LOWER_BOUND} to ${CITY_SELECTION_UPPER_BOUND} (at most) cities before proceeding!`
        },
        {
  ...
  render() {
    ...
    const RenderedCritiquingPage = props =>
        <CritiquingPage {...props}
          ...
          isLoading={isLoading}
          setRefinementsCompletedFlag={this.setRefinementsCompletedFlag}
          onNextStepClick={this.getSteps(3)[1].onNextClick}
      ...
      <React.Fragment>
        ...
        <StandardContainer>
          <Switch>
            ...
            <Route path={`${this.props.match.path}/critiquing`} render={RenderedCritiquingPage} />
