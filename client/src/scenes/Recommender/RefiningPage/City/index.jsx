      ...
      <ModifiedCard>
        ...
        <CardBodyVertical>
          ...
          <Content>
            ...
            <InfoBullet label="travel and transport">
              <ProgressBarWithMargin value={city.travelAndTransport} margin={5} />
            </InfoBullet>
            <InfoBullet label="shops and services">
              <ProgressBarWithMargin value={city.shopsAndServices} margin={5} />
            </InfoBullet>
          </Content>
        </CardBodyVertical>
      </ModifiedCard>
